...
namespace creative_web_Develop
{
    class ftpserver
    {
        ...
        protected string ftpdir { get; set; }
        protected string DirPathToUpload { get; set; }
        protected string BaseDirectory { get; set; }

        public ftpserver(string ftpuser, string ftppass, string ftpserverurl, string dirpathtoupload, string ftpdirectory)
        {
            this.FtpPass = ftppass;
            this.FtpUser = ftpuser;
            this.FtpServerUrl = ftpserverurl;
            this.ftpdir = ftpdirectory;
